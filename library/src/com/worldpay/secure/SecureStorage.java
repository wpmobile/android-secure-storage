...
public final class SecureStorage implements SecureInterface {
	...
	static final String KEYSTORE_FILENAME = "Secure.keystore";
	...
	public void clearAll() {
		secureHelper.clearAll(keyStorePassword);
	}
	 ...
	 */
	@Override
	public String encrypt(String text) throws InvalidKeyException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException {
	 ...
	 */
	@Override
	public String decrypt(String text) throws InvalidKeyException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException {
		return decrypt(text, 0);
	}
